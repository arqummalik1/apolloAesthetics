...
export function StorefrontHeader() {
  ...
  return (
    <header className="sticky top-2 z-30 rounded-[1.25rem] border border-white/70 bg-white/82 px-3 py-2 shadow-lg backdrop-blur sm:top-4 sm:rounded-[2rem] sm:px-5 sm:py-4">
      <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between lg:gap-4">
        <div className="min-w-0 space-y-1 sm:space-y-3">
          ...
          <div className="space-y-0.5 sm:space-y-1">
            ...
            <h1 className="truncate text-base font-semibold text-[color:var(--ink-900)] sm:text-xl lg:text-2xl">{config.title}</h1>
